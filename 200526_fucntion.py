...
conn = pymysql.connect(host ='127.0.0.1', port=3306, user='root', passwd='DB_passwd',db='alramy_db',charset='utf8')
...
def checkDB(exam):
    ...
    music_file = "/home/pi/Desktop/using_folder/alertsound.MP3"
...
try:
      while True:
            ...
            if distance < 10 and isParked == 0: ### 주차된 차 없을 때, 차가 주차구역 진입시
            ...
            elif isParked == 2 and distance < 10: ### 불법차량일 때, 아직도 주차중이라면 신고
                    print("신고")

            elif distance > 10 and isParked > 0:  ### 주차된 차가 있을 때, 차가 주차구역 벗어날 시
